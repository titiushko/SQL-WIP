...
/****** Object:  Database [CALL_CENTER]    Script Date: 01/16/2012 22:21:10 ******/
CREATE DATABASE [CALL_CENTER] ON  PRIMARY 
( NAME = N'CALL_CENTER', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL10_50.GC06016\MSSQL\DATA\CALL_CENTER.mdf' , SIZE = 6144KB , MAXSIZE = UNLIMITED, FILEGROWTH = 1024KB )
 LOG ON 
( NAME = N'CALL_CENTER_log', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL10_50.GC06016\MSSQL\DATA\CALL_CENTER_log.ldf' , SIZE = 1024KB , MAXSIZE = 2048GB , FILEGROWTH = 10%)
GO

ALTER DATABASE [CALL_CENTER] SET COMPATIBILITY_LEVEL = 100
GO
...
ALTER DATABASE [CALL_CENTER] SET AUTO_CREATE_STATISTICS ON 
GO
