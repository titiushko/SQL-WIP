INSERT INTO `move_flag_prose` (`move_flag_id`, `local_language_id`, `name`, `description`) VALUES
  ...
  (4, 10, 'Blokované Detectem a Protectem', 'Tento útok nebude fungovat, použil-li cíl toto kolo []{move:detect} ci [protect]{move:protect}.'),
  (11, 10, 'Rozmrazí pri použití', 'Tento útok muže zmražený pokémon použít k rozmrznutí.'),
  (5, 10, 'Odrazitelný', NULL),
  (10, 10, 'Nepoužitelný s Gravitací', 'Tento útok nelze použít pri [zvýšené gravitaci]{move:gravity} '),
  (3, 10, 'Má dobíjecí kolo', 'Kolo po použití tohoto útoku preskocí Pokémon svuj tah, aby se mohl dobít.'),
  (6, 10, 'Ukradnutelný', 'Tento útok bude ukraden, pokud jiný Pokémon toto kolo použil []{move:snatch}'),
  (8, 10, 'Úderový', NULL),
  (2, 10, 'Má nabíjecí kolo', 'Tento útok má nabíjecí kolo, které lze preskocit pomocí []{item:power-herb}.'),
  (9, 10, 'Zvukový', 'Pokémoni s []{ability:soundproof} jsou proti tomuto útoku odolní.'),
  (7, 10, 'Kopírovatelný Mirror Movem', 'Pokémon co je cílem tohoto útoku ho muže zkopírovat pomocí []{move:mirror-move}'),
  (1, 10, 'Zpusobí dotek', 'Uživatel se dotkne cíle.  Toto zaktivuje nekteré schopnosti (napr. []{ability:static}) a veci (napr. []{item:sticky-barb}).'),
  (13, 10, 'Lécí', 'Tento útok bude blokován pomocí []{move:heal-block}.');
