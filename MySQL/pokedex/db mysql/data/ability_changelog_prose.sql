INSERT INTO `ability_changelog_prose` (`ability_changelog_id`, `local_language_id`, `effect`) VALUES
  ...
  (37, 10, 'Nemá žádný úcinek v poli.'),
  (16, 10, 'Nemá žádný úcinek v poli.'),
  (3, 10, 'Nemá žádný úcinek v poli.'),
  (8, 10, 'Nemá žádný úcinek v poli.'),
  (7, 10, 'Nemá žádný úcinek v poli.'),
  (1, 10, 'Nemá žádný úcinek pri zápasu.'),
  (19, 10, 'Nemá žádný úcinek v poli.'),
  (22, 10, 'Nemá žádný úcinek v poli.'),
  (24, 10, 'Nemá žádný úcinek v poli.'),
  (4, 10, 'Neabsorbuje nezranující [elektrické]{type:electric} útoky, napr. []{move:thunder-wave}.'),
  (28, 10, 'Nemá žádný úcinek pri zápasu.'),
  (35, 10, 'Nemá žádný úcinek v poli.'),
  (2, 10, 'Funguje jen proti útokum, které vždy omrácí na jeden úder. (Ne proti tem, které jsou proste príliš silné.)'),
  (20, 10, 'Nemá žádný úcinek v poli.'),
  (30, 10, 'Nemá žádný úcinek v poli.'),
  (33, 10, 'Nemá žádný úcinek v poli.'),
  (13, 10, 'Nemá žádný úcinek v poli.'),
  (31, 10, 'Nemá žádný úcinek v poli.'),
  (25, 10, 'Nemá žádný úcinek v poli.'),
  (36, 10, 'Nemá žádný úcinek v poli.'),
  (10, 10, 'Nemá žádný úcinek v poli.'),
  (29, 10, 'Nemá žádný úcinek v poli.'),
  (26, 10, 'Nemá žádný úcinek v poli.');
