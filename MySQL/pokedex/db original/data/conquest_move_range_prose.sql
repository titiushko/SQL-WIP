INSERT INTO `conquest_move_range_prose` (`conquest_move_range_id`, `local_language_id`, `name`, `description`) VALUES
  (1, 9, 'User', 'The user.'),
  ...
  (19, 9, 'Dai', 'Seven tiles in the shape of the kanji ? (dai), consisting of five squares in a plus shape in front of the user and one square on either side of the user.'),
