INSERT INTO `pokemon_move_method_prose` (`pokemon_move_method_id`, `local_language_id`, `name`, `description`) VALUES
  ...
  (4, 10, 'Prístrojem', 'Ucené použitím TM nebo HM'),
  (5, 10, 'Stadium: Surfující Pikachu', NULL),
  (10, 10, 'Forma Rotoma', 'Objeví se u Rotoma, když se zmení do urcité formy.  Zmizí, když se Rotom zmení do jiné formy, pokud se tento útok dá naucit jen zmenou formy.'),
  (3, 10, 'Od ucitele', 'Ucené nejakou postavou ve hre.'),
  (6, 10, 'Light Ball', 'Objeví se u Pichu, jehož matka držela Light Ball. Otec nesmí být Ditto.'),
  (8, 10, 'XD: Stínový útok', 'U ukradených „Shadow“ pokémonu'),
  (2, 10, 'Vajíckový', 'Dedí se od otce.'),
  (9, 10, 'XD: Purifikace', 'Objeví se u „Shadow“ pokémona, jak se mu otevírá srdce.'),
  (7, 10, 'Colosseum: Purifikace', 'Objeví se u „Shadow“ pokémona, jak se mu otevírá srdce.'),
  (1, 10, 'Úrovní', 'Ucení dosažením urcité úrovne.');
