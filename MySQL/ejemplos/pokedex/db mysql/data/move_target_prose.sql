INSERT INTO `move_target_prose` (`move_target_id`, `local_language_id`, `name`, `description`) VALUES
  ...
  (4, 10, 'Strana uživatele', 'Uživatelova strana bojište.\n\nPusobí na uživatele i jeho spolubojovníky (jsou-li nejací)'),
  (5, 10, 'Uživatel nebo spolubojovník', 'Bud uživatel nebo jeho spolubojovník, podle trenéra.'),
  (3, 10, 'Spolubojovník', 'Spolubojovník uživatele (je-li nejaký).'),
  (6, 10, 'Strana protivnika', 'Opacná strana bojište.\n\nPusobí na protivníky.'),
  (2, 10, 'Vybraný Pokémon', 'Druhý Pokémon na bojišti, vybraný trenérem.\n\nUkradené útoky použijí stejný cíl.'),
  (7, 10, 'Uživatel', 'Pusobí na uživatele.'),
  (9, 10, 'Všichni ostatní pokémoni', 'Každý pokémon na poli, krome uživatele.'),
  (11, 10, 'Všichni protivníci', 'Všichni protivníci.'),
  (8, 10, 'Náhodný protivník', 'Jeden protivník, vybraný náhodne.'),
  (10, 10, 'Vybraný Pokémon', 'Jeden pokémon na poli krome uživatele, vybraný trenérem. ');
